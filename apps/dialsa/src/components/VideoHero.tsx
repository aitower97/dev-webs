...
export function VideoHero({
  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden">
      ...
      {/* Background video — no blur, GPU accelerated */}
      <video
        ref={videoRef}
        autoPlay
        muted
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse at center, transparent 50%, rgba(13,59,111,0.4) 100%)",
        }}
      />
