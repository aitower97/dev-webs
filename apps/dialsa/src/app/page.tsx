...
export default function HomePage() {
  return (
    <>
      ...
      {/* ===== HERO — Centrado, cinematográfico ===== */}
      <section className="relative flex min-h-screen items-center overflow-hidden">
        <Image src="/images/hero-pool.jpg" alt="Piscina Dialsa" fill className="object-cover" priority style={{ animation: "slow-zoom 20s ease-in-out infinite alternate" }} />
      ...
      {/* ===== SERVICIOS — Full-screen alternating, NO grid ===== */}
      ...
      {/* ===== GALERÍA — Scroll horizontal, NO grid ===== */}
      ...
      {/* ===== DIFERENCIADOR — Layout asimétrico, no cards grid ===== */}
      ...
      {/* ===== CTA — Full bleed, dramático ===== */}
      <section className="relative min-h-[60vh] flex items-center overflow-hidden">
        <Image src="/images/piscina-jardin.png" alt="" fill className="object-cover" />
